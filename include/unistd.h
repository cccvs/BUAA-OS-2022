...
#define SYS_getthreadid     ((__SYSCALL_BASE ) + (15 ) )
...
#define SYS_thread_create   ((__SYSCALL_BASE ) + (19 ))
#define SYS_thread_exit     ((__SYSCALL_BASE ) + (20 ))
#define SYS_thread_cancel   ((__SYSCALL_BASE ) + (21 ))
#define SYS_thread_setcancelstate   ((__SYSCALL_BASE ) + (22 ))
#define SYS_thread_setcanceltype    ((__SYSCALL_BASE ) + (23 ))
#define SYS_thread_testcancel   ((__SYSCALL_BASE ) + (24 ))
#define SYS_thread_detach   ((__SYSCALL_BASE ) + (25 ))
#define SYS_thread_join		((__SYSCALL_BASE ) + (26 ))
#define SYS_sem_init        ((__SYSCALL_BASE ) + (27 ))
#define SYS_sem_destroy		((__SYSCALL_BASE ) + (28 ))
#define SYS_sem_wait		((__SYSCALL_BASE ) + (29 ))
#define SYS_sem_trywait		((__SYSCALL_BASE ) + (30 ))
#define SYS_sem_post		((__SYSCALL_BASE ) + (31 ))
#define SYS_sem_getvalue	((__SYSCALL_BASE ) + (32 ))
#endif
